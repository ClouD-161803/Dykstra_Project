...
\begin{figure}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{Latex/Current Version/Figures/Stalling_vertical.png}
        \caption{Stalling situation.}
        \label{fig:stalling2}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{Latex/Current Version/Figures/No_stalling_vertical.png}
