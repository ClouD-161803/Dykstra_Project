...
\begin{figure}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{Latex/Current Version/Figures/stalling_notfixed_situation_2.png}
        \caption{Stalling situation.}
        \label{fig:stalling2}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth]{Latex/Current Version/Figures/stalling_fixed_situation_2.png}
